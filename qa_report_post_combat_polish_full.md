...
```json
{
  "game_version": "0.9.102",
  "build_name": "Pre-Engine QA Auditor + Safe Restructure Prep",
  "git_commit_hash": "fcfce69",
  "generated_at": "2026-03-09T08:15:29-03:00",
  "total_cards": 120,
  "total_cards_base": 60,
  ...
  "total_generated_assets": 177,
  "total_curated_assets": 1
}
```

## Baseline QA — WARNING

cards=120 avg_turns_battle=8.86 avg_turns_boss=9.29 boss_win_rate=1.0
...
missing_custom_files=5 missing_contexts=3
...
missing_scene_files=0 missing_portrait_assets=3

```json
{
  "missing_scene_files": [],
  "missing_portrait_assets": [
    "game\\assets\\curated\\avatars\\chakana_mage_master_concept.png",
    "game\\assets\\curated\\avatars\\chakana_mage_master_portrait.png",
    "game\\assets\\curated\\avatars\\chakana_mage_master_hologram.png"
  ],
...
```json
{
  ...
  "priority_2_visual_integrity": [
    ...
    "Scenes: missing_scene_files=0 missing_portrait_assets=3"
  ],
  "priority_3_maintainability": [
    "Baseline QA: cards=120 avg_turns_battle=8.86 avg_turns_boss=9.29 boss_win_rate=1.0",
    "Fonts: missing_custom_files=5 missing_contexts=3",
...
2. master avatar art pass (curated concept/portrait/hologram).
3. audio cache/manifest cleanup and context track verification.
